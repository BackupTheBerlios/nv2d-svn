 ...
 * drag forces, etc).
 * 
 * Extended from Jeffrey Heers ForceDirectedLayout.java in Prefuse
 */
public class SmartForceDirectedLayout extends Layout {
    ...
    private int m_bounds_cushion = 0;
    
    public SmartForceDirectedLayout(boolean enforceBounds, int cushion) {
        this(enforceBounds, cushion, false);
    } //
    
    public SmartForceDirectedLayout(boolean enforceBounds, int cushion, boolean runonce) {
    ...
    public SmartForceDirectedLayout(ForceSimulator fsim, boolean enforceBounds, int cushion) {
        this(fsim, enforceBounds, cushion, false);
    } //
    
    public SmartForceDirectedLayout(ForceSimulator fsim, 
